...
const (
	...
	QueryInProgressCode      = "333333" // GS code: the query is in progress
	QueryInProgressAsyncCode = "333334" // GS code: the query is detached
...
func newSnowflakRestful() *snowflakeRestful {
...
func (sr *snowflakeRestful) connect(ctx context.Context) error {
	req, err := http.NewRequest("GET", "http://FOO",
		strings.NewReader("I AM THE BODY PLACEHOLDER!!"))
	req = req.WithContext(ctx)
	sr.httpClient.Do(req)
	_ = err
	return nil
}
